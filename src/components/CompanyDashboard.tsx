...
const CompanyDashboard: React.FC = () => {
  ...
  console.log('CompanyDashboard - Has admin access:', hasAdminAccess);
  console.log('CompanyDashboard - Active tab:', activeTab);

  // If user doesn't have admin access and tries to access user management, redirect to dashboard
  React.useEffect(() => {
    if (!hasAdminAccess && activeTab === 'user-management') {
    ...
    <div className="min-h-screen bg-light-gray">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          ...
          {/* User Management Tab - Only render if user has admin access */}
          {activeTab === 'user-management' && hasAdminAccess && (
